...
namespace FTSS.API.Controllers.dbo
{
	...
	[ApiController]
	public class SalersHeadController : BaseController
	{
		/// <summary>
		...
		/// <returns></returns>
		[HttpPut]
		public IActionResult GetAll([FromBody] FTSS.Models.Database.StoredProcedures.MisExtract.dbo.SP_SalersHead_List.Inputs inputs)
		{
			var rst = _ctx_MisExtract.SP_SalersHead_List(inputs, JWTKey, JWTIssuer, _IHttpContextAccessor);
