...
namespace FTSS.Logic.UnitTests.Database
{
    ...
    class DatabaseContextDapperTests
    {
        ...
        {
            Assert.That(() => new Logic.Database.DatabaseContextDapper_MisExtract(cns),
        ...
        {
            var result = new Logic.Database.DatabaseContextDapper_MisExtract(cns);

            Assert.That(result, Is.Not.Null);
            Assert.That(result, Is.InstanceOf<Logic.Database.IDatabaseContext_MisExtract>());
        }
    }
}
