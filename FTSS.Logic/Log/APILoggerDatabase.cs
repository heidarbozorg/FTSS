...
namespace FTSS.Logic.Log
{
    ...
    {
        private readonly Database.IDatabaseContext_MisExtract _databaseContext;
        private readonly AutoMapper.IMapper _mapper;

        public APILoggerDatabase(Database.IDatabaseContext_MisExtract databaseContext, AutoMapper.IMapper mapper)
        {
