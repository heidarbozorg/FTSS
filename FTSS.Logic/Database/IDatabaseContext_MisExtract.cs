...
namespace FTSS.Logic.Database
{
    public interface IDatabaseContext_MisExtract
    {
        ...
        DBResult Sp_AmalkardKarkhaneh_Coal_Kharid_Tafkiki(Sp_AmalkardKarkhaneh_Coal_Kharid_Tafkiki.Inputs inputs, string key, string issuer, IHttpContextAccessor _IHttpContextAccessor);
